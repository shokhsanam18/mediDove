...
export const Blog = () => {
  ...
  const cardsInfoNews = [
    {
      ...
      description: 'There’s a good chance Everyday Health is the most appropriately named blog on this list because it focuses on the health topics that consistently affect a wide range of people. They also get kudos.',
      content: [
        <span key="user" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
          <FontAwesomeIcon icon={faUser} style={{ color: "#e1236b" }} /> 
          <span style={{ color: "#808e96" }}>Diboli</span>
        </span>,
        <span key="comments" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
 ...
 <div
    ...
    We are here for your care.
          ...
          <Typography variant="h2">Blog 3 Column</Typography>
        </div>
...
<div className="flex justify-center items-center space-x-3 my-12">
  ...
  {[1, 2, 3].map((page) => (
    <button
      ...
      ${page === 2 ? "bg-red-500 text-white" : "border border-gray-300 text-gray-500 hover:bg-gray-100"}`}
    >
      {page < 10 ? `0${page}` : page}
    </button>
  ))}
