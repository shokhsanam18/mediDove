  ...
  return (
      ...
      >
          <div className="flex flex-col w-full gap-6 md:w-2/3 lg:w-1/2">
            <Typography
              variant="h4"
              className="text-[#6A7B8F] font-semibold"
            >
              We are here for your care.
            </Typography>
            <h1 className={'text-6xl font-bold tracking-tight text-[#223645] sm:text-7xl/none'}>Best Care &amp; Better Doctor.</h1>
            <Typography
              variant="p"
            ...
            <div className='flex md:justify-start justify-center items-center gap-6'>
                ...
                <Link to='/BecomeMember'>
                    <button className="flex items-center h-16 uppercase w-72 rounded-full focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:bg-[#8fb569] text-white bg-[#e12454] shadow-[2px_2px_3px_#e1245397] hover:shadow-[0px_0px_3px_#8fb569] transition-all duration-300 ease-in-out font-semibold">
                        ...
                        <span className="ml-5 text-base uppercase font-semibold tracking-wide">make APPOINTMENT</span>
                    </button>
                </Link>
                <button className="flex items-center justify-center uppercase w-14 h-14 rounded-full focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-[#8fb569] text-white hover:bg-[#e12454] hover:shadow-[2px_2px_3px_#e1245397] shadow-[0px_0px_3px_#8fb569] transition-all duration-300 ease-in-out font-semibold"
      ...
      >
        ...
        {isModalOpen && (
                    ...
                    <div className="relative p-4 rounded-lg w-[90%] max-w-2xl">
                        ...
                        <iframe className="w-full h-64 sm:h-96" src="https://www.youtube.com/embed/oU_GUAWz52w?si=GQPIHAoWg11DmrPv;start=2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                    </div>
                )}
