...
const GetConsultant = () => {
  return (
    ...
    <div
    className=" relative inset-0 w-full bg-cover bg-no-repeat text-center md:flex justify-between xl:px-32 lg:px-20 sm:px-2 items-center py-[120px] bg-left h-full"
  ...
  >
    ...
    <div className="relative inset-0 flex flex-col justify-center items-center gap-5 text-white mx-auto">
        ...
        <Link to='/Blog' className='mt-7'>
            <button className="flex items-center h-16 w-72 rounded-full focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-[#8fb569] text-white hover:bg-[#e12454] shadow-[0px_0px_5px_#8fb569] hover:shadow-[0px_0px_3px_#e12454] transition-all duration-300 ease-in-out font-semibold ">
