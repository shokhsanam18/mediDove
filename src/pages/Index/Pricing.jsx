  ...
  return (
    <section className="flex w-full flex-col sm:px-[5%] px-[2%] pt-11 pb-16 gap-14 bg-[#F4F9FC]">
        ...
        <div className="flex items-center justify-between md:flex-row flex-col">
            ...
            <button className={`text-sm uppercase tracking-wide h-20 w-44 font-bold text-center rounded-full ${isYear ?  'text-[#223645] bg-white' :'bg-[#E51E50] text-white'}  transition-all`}
                onClick={() => setIsYear(false)}
            >
                monthly
            </button>
            <button className={`text-sm uppercase tracking-wide h-20 w-44 font-bold text-center rounded-full ${isYear ? 'bg-[#E51E50] text-white' : 'text-[#223645] bg-white' }  transition-all`}
